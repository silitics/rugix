...
for overlay_file in ${overlays}; do
	if load ${devtype} ${devnum}:${bootpart} ${load_addr} ${prefix}dtb/overlay/${overlay_prefix}-${overlay_file}.dtbo; then
...
if test "${overlay_error}" = "true"; then
	...
	if load ${devtype} ${devnum}:${bootpart} ${load_addr} ${prefix}dtb/overlay/${overlay_prefix}-fixup.scr; then
